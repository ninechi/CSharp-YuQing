<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="YuQing.Admin.Role.Edit" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#ff').form('load', 'Get.ashx?id=' + $("#roleid").val());
        });
        function edit() {
            $('#ff').form('submit', {
                url: 'Save.ashx?id=' + $("#roleid").val(),
                onSubmit: function () {
...
<body>
    <div class="easyui-panel" title="修改角色" style="width:100%;max-width:400px;padding:30px 60px;">
        ...
        <div style="text-align:center;padding:5px 0">
            <a href="javascript:void(0)" class="easyui-linkbutton" onclick="edit()" style="width:80px">修改</a>
