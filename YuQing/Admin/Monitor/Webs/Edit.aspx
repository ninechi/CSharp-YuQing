<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="YuQing.Admin.Monitor.Webs.Edit" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#ff').form('load', 'GetWeb.ashx?id=' + $("#webid").val());
        });
        function editWeb() {
            $('#ff').form('submit', {
                url: 'SaveWeb.ashx?id=' + $("#webid").val(),
                onSubmit: function () {
...
<body>
    <div class="easyui-panel" title="修改网站" style="width:100%;max-width:400px;padding:30px 60px;">
        ...
        <div style="text-align:center;padding:5px 0">
            <a href="javascript:void(0)" class="easyui-linkbutton" onclick="editWeb()" style="width:80px">修改</a>
        ...
        <input id="webid" type="hidden" runat="server" />
    </div>
</body>
</html>
