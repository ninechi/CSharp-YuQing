...
namespace SM.YuQing.DAL
{
    ...
    public partial class Config
    {
        ...
        public bool Add(SM.YuQing.Model.Config model)
        {
            ...
            strSql.Append("Name,Count,CreateTime,CreatePerson,UpdateTime,UpdatePerson)");
        ...
        public SM.YuQing.Model.Config GetModel(int ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 ID,Name,Count,CreateTime,CreatePerson,UpdateTime,UpdatePerson from Config ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)			};
            parameters[0].Value = ID;

            SM.YuQing.Model.Config model = new SM.YuQing.Model.Config();
        ...
        /// 得到一个对象实体
        /// </summary>
        public SM.YuQing.Model.Config DataRowToModel(DataRow row)
        {
            SM.YuQing.Model.Config model = new SM.YuQing.Model.Config();
            if (row != null)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,Name,Count,CreateTime,CreatePerson,UpdateTime,UpdatePerson ");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" ID,Name,Count,CreateTime,CreatePerson,UpdateTime,UpdatePerson ");
            strSql.Append(" FROM Config ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
