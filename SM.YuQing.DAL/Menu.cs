...
namespace SM.YuQing.DAL
{
    ...
    public partial class Menu
    {
        ...
        public bool Add(SM.YuQing.Model.Menu model)
        {
            ...
            strSql.Append("Name,ParentID,Url,Icons,Sort,CreateTime,CreatePerson,UpdateTime,UpdatePerson)");
        ...
        public bool Update(SM.YuQing.Model.Menu model)
        {
            ...
            parameters[4].Value = model.Icons;
        ...
        public SM.YuQing.Model.Menu GetModel(int ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 ID,Name,ParentID,Url,Icons,Sort,CreateTime,CreatePerson,UpdateTime,UpdatePerson from Menu ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)			};
            parameters[0].Value = ID;

            SM.YuQing.Model.Menu model = new SM.YuQing.Model.Menu();
        ...
        /// 得到一个对象实体
        /// </summary>
        public SM.YuQing.Model.Menu DataRowToModel(DataRow row)
        {
            SM.YuQing.Model.Menu model = new SM.YuQing.Model.Menu();
            if (row != null)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,Name,ParentID,Url,Icons,Sort,CreateTime,CreatePerson,UpdateTime,UpdatePerson ");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" ID,Name,ParentID,Url,Icons,Sort,CreateTime,CreatePerson,UpdateTime,UpdatePerson ");
            strSql.Append(" FROM Menu ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
